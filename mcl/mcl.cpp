...
float M[MAX][MAX]={0},conv[MAX][MAX]={0};
...
{
	if(argc < 3)
	{cout<<"USAGE : mcl r filename"<<endl;return 0;}
	...
	cout<<endl<<"Number Of Clusters in the given Graph using MCL : "<<nc<<endl<<endl;
	return 0;
}
